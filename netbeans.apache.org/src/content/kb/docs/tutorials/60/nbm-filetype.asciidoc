...
*Note:*You can use any icon. If you like, you can click on this one and save it locally, and then specify it in the wizard step above: image::images/Datasource.gif[]
...
Now, when an Abc file is opened, the OpenSupport class handles the opening, such that it opens the file into the TopComponent instead of the basic editor that DataEditorSupport provides. The link:https://platform.netbeans.org/tutorials/60/nbm-visual_library.html[+NetBeans Visual Library 6.0 Tutorial+] provides an example of what you can do to develop the TopComponent further.
...
*Version**Date**Changes*125 August 2005
...
815 April 2008Updated the styles (badge, table of contents, required software table) to the new format.
