...
[start=2]
2. Select the new project sample and click Next. Type a name in the project name field and define a project location.
...
link:https://netbeans.org/about/contact_form.html?to=3&subject=Feedback:%20Project%20Sample%20Module%207.2%20Tutorial[+Send Us Your Feedback+]
