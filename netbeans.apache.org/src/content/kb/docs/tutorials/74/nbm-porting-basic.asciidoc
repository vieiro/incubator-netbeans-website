...
Software or ResourceVersion RequiredNetBeans IDEversion 7.3 or aboveJava Developer Kit (JDK)link:http://java.sun.com/javase/downloads/index.jsp[+version 7 or above+]
