...
For troubleshooting purposes, you are welcome to download the link:http://java.net/projects/nb-api-samples/sources/api-samples/show/versions/7.3/tutorials/selection-management/3-of-4/EventManager[+completed tutorial source code+].
...
[start=2]
2. Right click the EventManager and choose Run and then, once it is started up, select Window > Properties to show the NetBeans Platform Properties window.
...
link:https://netbeans.org/about/contact_form.html?to=3&subject=Feedback:%20Nodes%20API%207.3%20Module%20Tutorial[+Send Us Your Feedback+]
