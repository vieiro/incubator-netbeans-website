...
Software or ResourceVersion Requiredlink:https://netbeans.org/downloads/index.html[+NetBeans IDE+]version 7.2 or 7.3link:http://java.sun.com/javase/downloads/index.jsp[+Java Developer Kit (JDK)+]version 6 or abovelink:http://repo1.maven.org/maven2/net/java/dev/rome/rome/1.0.0[+Rss and atOM utilitiEs+]link:http://repo1.maven.org/maven2/net/java/dev/rome/rome-fetcher/1.0.0[+Rome Fetcher+]link:http://jdom.org/downloads/index.html[+JDom+]link:https://netbeans.org/files/documents/4/550/feedreader-images.zip[+FeedReader icon and splash screen+]

For troubleshooting purposes, you are welcome to download the link:http://java.net/projects/nb-api-samples/sources/api-samples/show/versions/7.3/tutorials/FeedReader[+completed tutorial source code+].
...
link:https://netbeans.org/about/contact_form.html?to=3&subject=Feedback: NetBeans Platform 7.3 Feed Reader Tutorial[+Send Us Your Feedback+] 
