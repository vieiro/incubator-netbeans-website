...
[start=2]
2. Add two icons to the module, such as these below, in locations defined by the  ``icon16``  element and the  ``icon32``  element above:
...
[start=3]
3. Right-click the module, choose New | Other and then Module Development | XML Layer, as shown below:
...
[start=4]
4. Between the  ``filesystem``  tags, register the code snippet as follows:
...
[start=5]
5. Check that the source structure of your module is as follows:
...
link:https://netbeans.org/about/contact_form.html?to=3&subject=Feedback:%20Code%20Snippet%20Module%207.2%20Tutorial[+Send Us Your Feedback+]
