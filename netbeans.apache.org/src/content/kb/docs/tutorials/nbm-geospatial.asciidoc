...
For troubleshooting purposes, you are welcome to download the link:http://java.net/projects/nb-api-samples/sources/api-samples/show/versions/8.0/tutorials/geospatial[+completed tutorial source code+].
...
link:https://code.google.com/p/openmap/downloads/list[+OpenMap+] is an open-source map technology.
...
[start=3]
3. From the Geotoolkit distribution, copy  ``Countries.shp``  file, as well as the DBF, PRJ, and SHX file into your module.
...
[start=4]
4. In the MapTopComponent, use Geotoolkit as follows, as a first example to get started with your Geotoolkit/NetBeans Platform integration:
...
[start=2]
2. Define the Installer class as follows:
...
[start=3]
3. Add to the Installer created in the previous section the statements in bold below:
...
link:https://netbeans.org/about/contact_form.html?to=3&subject=Feedback: NetBeans Platform 8.0 Geospatial Tutorial[+Send Us Your Feedback+] 
