...
Software ou recursoVersão necessárialink:https://netbeans.org/downloads/index.html[+NetBeans IDE+]versão 6.9link:http://java.sun.com/javase/downloads/index.jsp[+Java Developer Kit (JDK)+]Versão 6 oulink:http://download.eclipse.org/equinox[+Equinox+]link:http://www.aqute.biz/Code/Download#sudoku[+Jogo Sudoku+]
