...
[start=2]
2. Type  ``org-netbeans-modules-htmleditor-snippets``  and in "Folder" browse to the "htmlcondetemplate" folder. Click Next and then click Finish.
...
[start=2]
2. Replace the comtent of the layer.xml file with the following:
...
[start=2]
2. Open an HTML file and type "snf". Press the Tab key and notice that the abbreviation expands. Do the same for "pe".
...
link:https://netbeans.org/about/contact_form.html?to=3&subject=Feedback:%20Code%20Template%20Module%20Tutorial%207.1[+Send Us Your Feedback+]
