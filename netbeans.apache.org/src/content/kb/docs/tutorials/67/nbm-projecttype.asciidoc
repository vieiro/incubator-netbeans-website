...
[start=4]
4. Open the project and you should see the Projects window displaying your project. The content of the "texts" folder should be shown in the Projects window:

image::images/sample-1.png[]


[start=5]
5. Right-click the project node and notice the project-level menu items that you defined earlier:
