...
230 November 2005
* Changed the ZIP file because of problems (see link:https://netbeans.org/issues/show_bug.cgi?id=69571[+Issue 69571+]).
* Removed hyphens and changed screenshots.
All other issues from above must still be done.38 December 2005
* Fixed reopened issue link:https://netbeans.org/issues/show_bug.cgi?id=69571[+Issue 69571+]
